...
// CORREÇÃO: Importar do pacote .web.cors e NÃO do .web.cors.reactive
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                .csrf(csrf -> csrf.disable()) // Remover para produção
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        // Origem do seu Frontend React/Next
        ...
        // Permite envio de cookies ou headers de autenticação
